...
public final class OperatorEvaluatorGeDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorGeDouble(this);
        }
    }

    private OperatorEvaluatorGeDouble(Builder builder) {
    }
    ...
    public void apply(Value result, Value... operands) {
        ...
        ValueBoolean.as(result).set(op1 + 1E-6 >= op2);
    }
}
