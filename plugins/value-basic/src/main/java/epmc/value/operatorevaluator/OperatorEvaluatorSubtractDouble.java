...
public final class OperatorEvaluatorSubtractDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorSubtractDouble(this);
        }
    }

    private OperatorEvaluatorSubtractDouble(Builder builder) {
    }
