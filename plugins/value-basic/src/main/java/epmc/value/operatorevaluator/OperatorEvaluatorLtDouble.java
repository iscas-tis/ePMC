...
public final class OperatorEvaluatorLtDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorLtDouble(this);
        }
    }

    private OperatorEvaluatorLtDouble(Builder builder) {
    }
