...
public final class OperatorEvaluatorMaxInt implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorMaxInt(this);
        }
    }

    private OperatorEvaluatorMaxInt(Builder builder) {
    }
