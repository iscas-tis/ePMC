...
public final class OperatorEvaluatorEqBoolean implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorEqBoolean(this);
        }
    }

    private OperatorEvaluatorEqBoolean(Builder builder) {
    }
