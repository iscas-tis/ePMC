...
public final class OperatorEvaluatorIsOneDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorIsOneDouble(this);
        }
    }

    private OperatorEvaluatorIsOneDouble(Builder builder) {
    }
