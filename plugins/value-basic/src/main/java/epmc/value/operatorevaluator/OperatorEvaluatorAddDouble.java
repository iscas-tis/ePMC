...
public final class OperatorEvaluatorAddDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorAddDouble(this);
        }
    }

    private OperatorEvaluatorAddDouble(Builder builder) {
    }
