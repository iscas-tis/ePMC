...
public final class OperatorEvaluatorLtInt implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorLtInt(this);
        }
    }

    private OperatorEvaluatorLtInt(Builder builder) {
    }
