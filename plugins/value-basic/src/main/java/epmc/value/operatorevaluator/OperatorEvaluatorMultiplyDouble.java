...
public final class OperatorEvaluatorMultiplyDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorMultiplyDouble(this);
        }
    }

    private OperatorEvaluatorMultiplyDouble(Builder builder) {
    }
