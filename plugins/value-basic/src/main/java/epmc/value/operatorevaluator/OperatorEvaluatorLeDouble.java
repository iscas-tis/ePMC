...
public final class OperatorEvaluatorLeDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorLeDouble(this);
        }
    }

    private OperatorEvaluatorLeDouble(Builder builder) {
    }
    ...
    public void apply(Value result, Value... operands) {
        ...
        ValueBoolean.as(result).set(op1 <= op2 + 1E-6);
    }
}
