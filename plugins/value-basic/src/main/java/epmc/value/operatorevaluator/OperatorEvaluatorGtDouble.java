...
public final class OperatorEvaluatorGtDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorGtDouble(this);
        }
    }

    private OperatorEvaluatorGtDouble(Builder builder) {
    }
