...
public final class OperatorEvaluatorPowDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorPowDouble(this);
        }
    }

    private OperatorEvaluatorPowDouble(Builder builder) {
    }
