...
public final class OperatorEvaluatorGeInt implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorGeInt(this);
        }
    }

    private OperatorEvaluatorGeInt(Builder builder) {
    }
