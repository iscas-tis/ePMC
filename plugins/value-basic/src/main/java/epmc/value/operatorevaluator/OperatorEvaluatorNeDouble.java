...
public final class OperatorEvaluatorNeDouble implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorNeDouble(this);
        }
    }

    private OperatorEvaluatorNeDouble(Builder builder) {
    }
