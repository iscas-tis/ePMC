...
public final class ExpressionTemporalUntil implements Expression {
    public final static class Builder {
        ...
        public ExpressionTemporalUntil build() {
            return new ExpressionTemporalUntil(this);
        }
    }
    
    public static boolean is(Object expression) {
        return expression instanceof ExpressionTemporalUntil;
    }

    public static ExpressionTemporalUntil as(Expression expression) {
        if (is(expression)) {
            return (ExpressionTemporalUntil) expression;
        } else {
            return null;
        }
    }
    ...
    private ExpressionTemporalUntil(Builder builder) {
        assert builder != null;
    ...
    public boolean equals(Object obj) {
        assert obj != null;
        if (!(obj instanceof ExpressionTemporalUntil)) {
            return false;
        }
        ExpressionTemporalUntil other = (ExpressionTemporalUntil) obj;
