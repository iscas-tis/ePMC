...
public final class EvaluatorDDOperatorVectorGe implements EvaluatorDD {
    ...
    public boolean canHandle() throws EPMCException {
        return UtilEvaluatorDD.canIntegerVectorOperator(context, expression, OperatorGe.IDENTIFIER, variables);
    }

    @Override
    public void build() throws EPMCException {
        dd = UtilEvaluatorDD.applyVector(context, expression, variables, getContextDD()::twoCplGe);
    }
