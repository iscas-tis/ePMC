...
public final class EvaluatorDDOperatorVectorAdd implements EvaluatorDD {
    ...
    public boolean canHandle() throws EPMCException {
        return UtilEvaluatorDD.canIntegerVectorOperator(context, expression, OperatorAdd.IDENTIFIER, variables);
    }

    @Override
    public void build() throws EPMCException {
        vector = UtilEvaluatorDD.applyVector(context, expression, variables, getContextDD()::twoCplAdd);
