...
public final class EvaluatorDDOperatorVectorEq implements EvaluatorDD {
    ...
    public boolean canHandle() throws EPMCException {
        return UtilEvaluatorDD.canVectorOperator(context, expression, OperatorEq.IDENTIFIER, variables);
    }

    @Override
    public void build() throws EPMCException {
        dd = UtilEvaluatorDD.applyVector(context, expression, variables, getContextDD()::twoCplEq);
    }
