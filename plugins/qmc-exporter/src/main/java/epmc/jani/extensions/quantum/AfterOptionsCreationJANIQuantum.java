...
package epmc.jani.extensions.quantum;
...
public class AfterOptionsCreationJANIQuantum implements AfterOptionsCreation {
    private final static String IDENTIFIER = "after-options-creation-jani-quantum";
