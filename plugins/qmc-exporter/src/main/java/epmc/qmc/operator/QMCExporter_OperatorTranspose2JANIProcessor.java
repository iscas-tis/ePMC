...
public class QMCExporter_OperatorTranspose2JANIProcessor implements OperatorProcessor {
    ...
    public OperatorProcessor setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorTranspose.TRANSPOSE);
