...
public class QMCExporter_OperatorKetToVector2JANIProcessor implements OperatorProcessor {
    private static final String OP = "op";
    private static final String KET_VECTOR = "ket-vector";
    ...
    public OperatorProcessor setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorKetToVector.KET_TO_VECTOR);
