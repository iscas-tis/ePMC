...
/**
 * Command to start QMC exporter to JANI.
 * 
 * @author Andrea Turrini
 */
public final class CommandTaskQMCExporterQMCExport2JANI implements CommandTask {
    /** Unique identifier of QMC to JANI converter start command. */
    public static final String IDENTIFIER = "qmc-export-to-jani";
