...
/**
 * Non-stochastic parity game solver.
...
interface SolverNonStochastic {
    ...
    /**
     * Set the parity game to be solved.
     ...
     * players even ({@link Player#ONE}) or odd ({@link Player#TWO} to the
     ...
     * 
     * @param game parity game to be solved
     */
