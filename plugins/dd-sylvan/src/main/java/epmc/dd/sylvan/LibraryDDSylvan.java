...
public final class LibraryDDSylvan implements LibraryDD {
    ...
    public void setContextDD(ContextDD contextDD) throws EPMCException {
        ...
        long initMem = contextDD.getOptions().getInteger(OptionsDDSylvan.DD_SYLVAN_INIT_NODES);
        long initCache = contextDD.getOptions().getInteger(OptionsDDSylvan.DD_SYLVAN_INIT_CACHE_SIZE);
        int cacheGranularity = contextDD.getOptions().getInteger(OptionsDDSylvan.DD_SYLVAN_CACHE_GRANULARITY);
