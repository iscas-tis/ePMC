...
public final class NativeTools {
    ...
    private final static boolean loaded =
    		JNATools.registerLibrary(EPMCPolynomial.class, "epmc_polynomial");
	...
	public static Pointer polynomialToNative(ValueFunctionPolynomial polynomial) {
    	assert loaded;
    	assert polynomial != null;
	...
	public static void nativeToPolynomialDirect(ValueFunctionPolynomial result, Pointer polynomial) {
    	assert loaded;
		assert result != null;
		assert polynomial != null;
	...
	public static void nativeToPolynomialFixOrder(ValueFunctionPolynomial result, Pointer polynomial) {
    	assert loaded;
		assert result != null;
		assert polynomial != null;
		int numParameters = NativeTools.polynomialGetNumParameters(polynomial);
