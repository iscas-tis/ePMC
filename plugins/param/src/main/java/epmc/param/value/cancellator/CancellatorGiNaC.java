...
public final class CancellatorGiNaC implements Cancellator {
    ...
    public CancellatorGiNaC(TypeFunctionPolynomial type) {
    	assert loaded;
    	assert type != null;
    }
	...
	public void cancel(ValueFunctionPolynomial function1,
		...
		NativeTools.nativeToPolynomialDirect(function1, struct1);
		NativeTools.nativeToPolynomialDirect(function2, struct2);
