...
public final class EvaluatorSetIntervalIntervalDoubleFraction implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            if (!TypeRational.is(TypeInterval.as(types[0]).getEntryType())) {
                return null;
            }
            ...
            return new EvaluatorSetIntervalIntervalDoubleFraction(this);
        }
    }

    private final TypeInterval resultType;
    
    private EvaluatorSetIntervalIntervalDoubleFraction(Builder builder) {
        assert builder != null;
    ...
    public void apply(Value result, Value... operands) {
        ...
        ValueRational valueLowerRational = ValueRational.as(valueInterval.getIntervalLower());
        ValueRational valueUpperRational = ValueRational.as(valueInterval.getIntervalUpper());
        ...
        resultLowerDouble.set(UtilPoints.rationalToDouble(valueLowerRational, Side.LEFT));
        resultUpperDouble.set(UtilPoints.rationalToDouble(valueUpperRational, Side.RIGHT));
    }
}
