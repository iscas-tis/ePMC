...
public final class EvaluatorAddInverseRational implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new EvaluatorAddInverseRational(this);
        }
    ...
    private EvaluatorAddInverseRational(Builder builder) {
        assert builder != null;
    ...
    public void apply(Value result, Value... operands) {
        ...
        resultRational.set(valueRational.getNumerator().negate(), valueRational.getDenominator());
    }
}
