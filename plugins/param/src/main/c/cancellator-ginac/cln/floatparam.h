...
/* Largest n for which 1+2^(-n) is exactly represented is 63. */
/* Largest n for which 1-2^(-n) is exactly represented is 64. */
#define long_double_mant_bits 64
#define long_double_rounds rounds_to_nearest

#define double_wordorder_bigendian_p 0
