...
public final class OperatorEvaluatorEqSuperOperator implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorEqSuperOperator(this);
        }
    }

    private final OperatorEvaluator subtract;
    
    private OperatorEvaluatorEqSuperOperator(Builder builder) {
        subtract = ContextValue.get().getEvaluator(OperatorSubtract.SUBTRACT,
                TypeSuperOperator.as(builder.types[0]).getTypeMatrix(),
                TypeSuperOperator.as(builder.types[1]).getTypeMatrix());
    }
