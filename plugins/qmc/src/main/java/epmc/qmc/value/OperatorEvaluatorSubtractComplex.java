...
public final class OperatorEvaluatorSubtractComplex implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorSubtractComplex(this);
        }
    }

    private OperatorEvaluatorSubtractComplex(Builder builder) {
    }
    ...
    public void apply(Value result, Value... operands) {
        ...
        subtract.apply(resultReal, op1Real, op2Real);
        subtract.apply(resultImag, op1Imag, op2Imag);
    }
