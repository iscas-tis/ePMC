...
public final class OperatorEvaluatorIsZeroComplex implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            return new OperatorEvaluatorIsZeroComplex(this);
        }
    }

    private final ValueBoolean cmpReal;
    private final ValueBoolean cmpImag;
    private final OperatorEvaluator isZero;
    
    private OperatorEvaluatorIsZeroComplex(Builder builder) {
        cmpReal = TypeBoolean.get().newValue();
        cmpImag = TypeBoolean.get().newValue();
    ...
    public void apply(Value result, Value... operands) {
        ...
        isZero.apply(cmpReal, opReal);
        isZero.apply(cmpImag, opImag);
        ValueBoolean.as(result).set(cmpReal.getBoolean() && cmpImag.getBoolean());
    }
