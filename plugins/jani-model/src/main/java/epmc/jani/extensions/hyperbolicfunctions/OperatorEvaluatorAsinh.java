...
public final class OperatorEvaluatorAsinh implements OperatorEvaluator {
    public final static class Builder implements OperatorEvaluatorSimpleBuilder {
        ...
        public OperatorEvaluator build() {
            ...
            if (operator != OperatorAsinh.ASINH) {
                return null;
            }
            if (types.length != 1) {
                return null;
            ...
            return new OperatorEvaluatorAsinh(this);
        }
    }

    private OperatorEvaluatorAsinh(Builder builder) {
    }

    @Override
    public Operator getOperator() {
        return OperatorAsinh.ASINH;
    }
