 ...
 *
 */
public class PRISMExporter_OperatorDivideProcessor implements PRISMExporter_OperatorProcessorStrict {
    ...
    public PRISMExporter_OperatorProcessorStrict setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorDivide.DIVIDE);
