 ...
 *
 */
public class OperatorAbsProcessor implements JANI2PRISMOperatorProcessorNonPRISM {
    ...
    public JANI2PRISMOperatorProcessorStrict setOperatorElement(Operator operator, Object obj) {
        ...
        assert operator.equals(OperatorAbs.ABS);
    ...
    public List<String> getUnsupportedFeature() {
        ...
        ll.add(NonPRISMFeaturesPRISMExporter.PRISM_EXPORTER_NONPRISM_FEATURE_OPERATOR_ABS);
        return ll;
    }
