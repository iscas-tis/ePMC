 ...
 *
 */
public class PRISMExporter_OperatorNeProcessor implements PRISMExporter_OperatorProcessorStrict {
    ...
    public PRISMExporter_OperatorProcessorStrict setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorNe.NE);
