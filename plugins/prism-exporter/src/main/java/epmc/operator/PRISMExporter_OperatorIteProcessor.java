 ...
 *
 */
public class PRISMExporter_OperatorIteProcessor implements PRISMExporter_OperatorProcessorStrict {
    ...
    public String toPRISM() {
        ...
        prism.append(" : ");
        appendWithParenthesesIfNeeded(this, expressionOperator.getOperand3(), prism);
