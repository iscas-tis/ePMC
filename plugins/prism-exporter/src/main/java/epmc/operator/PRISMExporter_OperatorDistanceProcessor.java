 ...
 *
 */
public class PRISMExporter_OperatorDistanceProcessor implements PRISMExporter_OperatorProcessorNonPRISM {
    ...
    public PRISMExporter_OperatorProcessorNonPRISM setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorDistance.DISTANCE);
    ...
    public List<String> getUnsupportedFeature() {
        ...
        ll.add(NonPRISMFeaturesPRISMExporter.PRISM_EXPORTER_NONPRISM_FEATURE_OPERATOR_DISTANCE);
        return ll;
    }
}
