 ...
 *
 */
public class PRISMExporter_OperatorDivideIgnoreZeroProcessor implements PRISMExporter_OperatorProcessorNonPRISM {
    ...
    public PRISMExporter_OperatorProcessorNonPRISM setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorDivideIgnoreZero.DIVIDE_IGNORE_ZERO);
