 ...
 *
 */
public class PRISMExporter_OperatorGeProcessor implements PRISMExporter_OperatorProcessorStrict {
    ...
    public PRISMExporter_OperatorProcessorStrict setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorGe.GE);
