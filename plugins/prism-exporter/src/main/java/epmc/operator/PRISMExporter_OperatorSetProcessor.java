 ...
 *
 */
public class PRISMExporter_OperatorSetProcessor implements PRISMExporter_OperatorProcessorNonPRISM {
    ...
    public PRISMExporter_OperatorProcessorNonPRISM setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorSet.SET);
    ...
    public List<String> getUnsupportedFeature() {
        ...
        ll.add(NonPRISMFeaturesPRISMExporter.PRISM_EXPORTER_NONPRISM_FEATURE_OPERATOR_SET);
        return ll;
    }
}
