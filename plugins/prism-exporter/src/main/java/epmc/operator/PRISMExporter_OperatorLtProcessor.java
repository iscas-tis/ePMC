 ...
 *
 */
public class PRISMExporter_OperatorLtProcessor implements PRISMExporter_OperatorProcessorStrict {
    ...
    public PRISMExporter_OperatorProcessorStrict setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorLt.LT);
