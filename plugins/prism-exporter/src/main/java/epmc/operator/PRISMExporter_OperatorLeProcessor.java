 ...
 *
 */
public class PRISMExporter_OperatorLeProcessor implements PRISMExporter_OperatorProcessorStrict {
    ...
    public PRISMExporter_OperatorProcessorStrict setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorLe.LE);
