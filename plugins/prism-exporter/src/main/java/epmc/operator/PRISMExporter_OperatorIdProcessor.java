 ...
 *
 */
public class PRISMExporter_OperatorIdProcessor implements PRISMExporter_OperatorProcessorNonPRISM {
    ...
    public PRISMExporter_OperatorProcessorNonPRISM setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorId.ID);
