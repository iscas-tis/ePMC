 ...
 *
 */
public class PRISMExporter_OperatorWidenProcessor implements PRISMExporter_OperatorProcessorNonPRISM {
    ...
    public PRISMExporter_OperatorProcessorNonPRISM setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorWiden.WIDEN);
