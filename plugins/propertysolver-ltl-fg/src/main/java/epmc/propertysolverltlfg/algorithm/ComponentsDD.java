...
public class ComponentsDD implements Closeable {
    ...
    public ComponentsDD(GraphDD graph, DD nodes, DD limit,
    		boolean onlyBSCC, boolean skipTransient) throws EPMCException {
        assert graph != null;
        assert nodes != null;
        ...
        this.transitions = graph.getTransitions().and(limit);
        this.transitionsNoActions = transitions.abstractExist(graph.getActionCube()).andWith(limit.clone());
        this.graph = graph;
    ...
    public ComponentsDD(GraphDD graph, DD nodes, DD limit, boolean skipTransient) throws EPMCException {
        this(graph, nodes, limit, true, skipTransient);
    }
