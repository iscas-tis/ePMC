...
import epmc.propertysolverltlfg.automaton.AutomatonDDDTA;
 ...
 * @author Yong Li
 */
public final class PropertySolverDDLTLTGRA extends PropertySolverDDLTL {
    public final static String IDENTIFIER = "ltl-tgra-dd";
	...
	AutomatonDD constructRabinDD(AutomatonRabin rabin, DD modelStates) 
    	...
    	return new AutomatonDDDTA(expressionToDD, rabin, modelStates);
    }
    ...
    private boolean decideComponentMDPLeaf(AutomatonDDDTA automaton, DD leafSCC
    ...
    private DD getLableDD(AcceptanceLabel label, AutomatonDDDTA automatonDD) 
    		throws EPMCException {
	...
	DD computeAcceptedMECs(ProductGraphDD product, AutomatonDD automatonDD, DD nodeSpace) 
            throws EPMCException {
    	AutomatonDDDTA automaton = (AutomatonDDDTA)automatonDD;
