...
public final class PropertyGuardedCommand implements Property {
	...
	public Expression parseExpression(InputStream stream) throws EPMCException {
		assert stream != null;
		GuardedCommandTemporalExpressionParser parser = new GuardedCommandTemporalExpressionParser(stream);
