...
import epmc.guardedcommand.temporal.GuardedCommandTemporalExpressionParser;
import epmc.jani.model.type.JANIType;
import epmc.jani.model.type.JANITypeBool;
import epmc.value.ContextValue;

/**
 * Class to collect the formulas, constants, and labels of a GuardedCommand model during parsing.
 * This class is not meant for general storage of non-GuardedCommand models.
 *
...
public final class Formulas {
    ...
    public void addLabel(String label, Expression value) {
        ...
        typeBool.setContextValue(context);
    ...
    private void checkCyclic() throws EPMCException {
        for (Entry<Expression, Expression> entry : constants.entrySet()) {
            ...
            Set<Expression> onPath = new HashSet<>();
                    ...
                    ProblemsGuardedCommand.CONST_CYCLIC,
    ...
    private void checkNonConstantConst() throws EPMCException {
        ...
        for (Entry<Expression, Expression> entry : constants.entrySet()) {
            ...
            ensure(constant == null, ProblemsGuardedCommand.CONST_NON_CONST, entry.getKey());
        }
    }
    ...
    public void ensureNoUndefinedConstants() throws EPMCException {
        for (Entry<Expression,Expression> entry : constants.entrySet()) {
            ...
            ensure(entry.getValue() != null, ProblemsGuardedCommand.CONST_UNDEFINED, key.getName());
        }
    }
    
    private Expression parse(Reader reader) throws EPMCException {
        assert reader != null;
        GuardedCommandTemporalExpressionParser parser = new GuardedCommandTemporalExpressionParser(reader);
