 ...
 *
 */
public class JANIExporter_OperatorMinProcessor implements OperatorProcessor {
    ...
    public OperatorProcessor setExpressionOperator(ExpressionOperator expressionOperator) {
        ...
        assert expressionOperator.getOperator().equals(OperatorMin.MIN);
    ...
    public JsonValue toJSON() {
        ...
        if (JANIExporter_ProcessorRegistrar.useDerivedOperators()) {
            ...
            builder.add(THEN, JANIExporter_ProcessorRegistrar.getProcessor(expressionOperator.getOperand1())
                    .toJSON());
            builder.add(ELSE, JANIExporter_ProcessorRegistrar.getProcessor(expressionOperator.getOperand2())
                    .toJSON());
        }        
