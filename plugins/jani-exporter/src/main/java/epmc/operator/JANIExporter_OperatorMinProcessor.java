...
public class JANIExporter_OperatorMinProcessor implements OperatorProcessor {
    ...
    public JsonValue toJSON() {
        ...
        if (ProcessorRegistrar.useDerivedOperators()) {
            ...
            builder.add(THEN, ProcessorRegistrar.getProcessor(expressionOperator.getOperand1())
                    .toJSON());
            builder.add(ELSE, ProcessorRegistrar.getProcessor(expressionOperator.getOperand2())
                    .toJSON());
        }        
