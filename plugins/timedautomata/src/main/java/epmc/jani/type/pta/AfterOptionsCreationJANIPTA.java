...
public class AfterOptionsCreationJANIPTA implements AfterOptionsCreation {
	private final static String IDENTIFIER = "jani-pta";
	...
	private void addSemantics(Options options) {
		...
		modelSemanticTypes.put(ModelExtensionPTA.IDENTIFIER, ModelExtensionPTA.class);
