...
public class AfterOptionsCreationJANITA implements AfterOptionsCreation {
	private final static String IDENTIFIER = "jani-ta";
	...
	private void addSemantics(Options options) {
		...
		modelSemanticTypes.put(ModelExtensionTA.IDENTIFIER, ModelExtensionTA.class);
