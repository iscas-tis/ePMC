...
public class AfterOptionsCreationJANISTA implements AfterOptionsCreation {
	private final static String IDENTIFIER = "jani-sta";
	...
	private void addSemantics(Options options) {
		...
		modelSemanticTypes.put(ModelExtensionSTA.IDENTIFIER, ModelExtensionSTA.class);
